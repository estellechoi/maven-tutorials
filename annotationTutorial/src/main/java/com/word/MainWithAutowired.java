...
import com.word.service.WordRegisterWithAutowired;
import com.word.service.WordSearch;
import com.word.service.WordSearchWithAutowired;

public class MainWithAutowired {

	public static void main(String[] args) {

		GenericXmlApplicationContext ctx = new	GenericXmlApplicationContext("classpath:appContextWithAutowired.xml");
		
		// 단어 등록 
		WordRegisterWithAutowired wordRegister = ctx.getBean("wordRegister", WordRegisterWithAutowired.class);
